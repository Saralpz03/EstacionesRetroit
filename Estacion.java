...
class Estacion {
    ...
    public Estacion(String estacion_analizador_NO2, String estacion_analizador_SO2, String estacion_municipio, String estacion_direccion_postal) {
    ...
    public String toString() {
        return "\nEstacion{" + "estacion_analizador_NO2=" + estacion_analizador_NO2 + "\n, estacion_analizador_SO2=" + estacion_analizador_SO2 + "\n, estacion_municipio=" + estacion_municipio + "\n, estacion_direccion_postal=" + estacion_direccion_postal + '}';
    }
